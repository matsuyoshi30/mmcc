...
assert 0 'main() { return 4!=4; }'
assert 1 'main() { return 5>3; }'
assert 0 'main() { return 6>=9; }'
assert 1 'main() { return 4<5; }'
assert 0 'main() { return 6<=3; }'

assert 5 'main() { a=5; return a; }'
assert 1 'main() { c=5>3; return c; }'
assert 10 'main() { foo=10; return foo; }'
assert 123 'main() { bar=10; bar=123; return bar; }'
assert 22 'main() { a=13; b=a+9; return b; }'
